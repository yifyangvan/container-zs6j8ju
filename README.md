...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zs6j8ju.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zs6j8ju.containers.anotherwebservice.com/
...
```
git clone git@github.com:yifyangvan/container-zs6j8ju.git
cd container-zs6j8ju
```
...
```
docker attach container-zs6j8ju
```
